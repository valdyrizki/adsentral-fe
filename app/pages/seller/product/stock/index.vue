    ...
    <UCard class="shadow-sm">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        ...
        <div class="flex gap-2">
          ...
          <UButton icon="mdi:refresh" color="neutral" variant="outline" :loading="pending" class="flex-1" @click="refresh()">
            Refresh
          </UButton>
      ...
      <div v-else class="divide-y divide-gray-100">
        ...
        >
          ...
          <div class="flex-none flex items-center gap-2">
            ...
            <NuxtLink :to="`/seller/product/stock/${item.product_id}`">
...
definePageMeta({ layout: 'seller', label: 'Stok File', ssr: false })
...
const {
  ...
  () => `seller-all-stock-${page.value}-${perPageValue.value}-${JSON.stringify(filters)}`,
  () => getMyAllStockItems(page.value, perPageValue.value, { ...filters }),
