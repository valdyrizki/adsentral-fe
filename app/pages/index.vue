          ...
          <div class="pt-10 pb-4 text-center">
            ...
            <div class="mt-3 flex flex-col items-center">
              ...
              <div class="flex items-center">
                <UIcon name="material-symbols:kid-star" v-for="rating in [0, 1, 2, 3, 4]" :key="rating" :class="[product.rating > rating ? 'text-yellow-400' : 'text-gray-200', 'size-5 shrink-0']" aria-hidden="true" />
